                ...
                <div class="accordion" id="accordionExample">
                  ...
                  <div class="accordion-item">
                    <h3 class="accordion-header" id="headingSeven">
                      <div class="ps-3">
                        <button class="float-end btn button-light d-inline no-focus-btn" type="button" data-bs-toggle="collapse" data-bs-target="#collapseSeven" aria-expanded="false" aria-controls="collapseSeven">
                          <i class="bi bi-chevron-down"></i>
                        </button>
                        <div class="h4 d-inline" type="button" data-bs-toggle="collapse" data-bs-target="#collapseSeven" aria-expanded="false" aria-controls="collapseSeven">
                        Rotation Period (hr)
                        </div>
                      </div>
                    </h3>
                  ...
                  <div class="accordion-item">
                    <h3 class="accordion-header" id="headingeight">
                      <div class="ps-3">
                        <button class="float-end btn button-light d-inline no-focus-btn" type="button" data-bs-toggle="collapse" data-bs-target="#collapseeight" aria-expanded="false" aria-controls="collapseeight">
                          <i class="bi bi-chevron-down"></i>
                        </button>
                        <div class="h4 d-inline" type="button" data-bs-toggle="collapse" data-bs-target="#collapseeight" aria-expanded="false" aria-controls="collapseeight">
                        Rotation model
                        </div>
                      </div>
                    </h3>
...
export default {
  ...
  data () {
    return {
      ...
      info_index: ["Discovered by", "Discovered date", "long (km)", "perihelion distance (AU)", "Asteroid category", "Absolute magnitude (H)"]
    }
  },
  watch: {
      param: {
